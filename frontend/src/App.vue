      ...
      <div class="apps-outer" :style="outerStyle">
        <div class="apps-inner">
          ...
          <div v-if="sortMode" class="sort-bar">
            <button class="sort-btn" @click="exitSort(true)">💾 {{ lang === 'en' ? 'Save Order' : '保存排序' }}</button>
...
const clockHtml = ref('')
const dispSet   = reactive({ hostnameSize: 56, clockSize: 16, iconSize: 78, appNameSize: 12, iconRadius: 26, iconGap: 22, sidePadding: 52 })
